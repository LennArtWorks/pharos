<script lang="ts">
	...
	const sizeClasses = {
		xs: 'h-main-xs font-label-s font-semibold gap-3xs leading-none',
		s: 'h-main-s font-label-s font-semibold gap-3xs leading-none',
		sm: 'h-main-s font-label-s font-semibold gap-2xs leading-none',
