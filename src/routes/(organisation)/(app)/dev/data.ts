...
export const foundations: ComponentDef[] = [
  ...
  {
    name: 'Spacing',
    href: '/dev/design-system/spacing',
    desc: "",
    importStr: "",
  ...
  {
    name: 'Permissions',
    href: '/dev/design-system/permissions',
    desc: "",
    importStr: "",
...
export const uiComponents: ComponentDef[] = [
  {
    name: 'Button',
    href: '/dev/design-system/ui/button',
  ...
  {
    name: 'Input',
    href: '/dev/design-system/ui/input',
  ...
  {
    name: 'MouseTooltip',
    href: '/dev/design-system/ui/mousetooltip',
  ...
  {
    name: 'Divider',
    href: '/dev/design-system/ui/divider',
...
export const layouts: ComponentDef[] = [
  {
    name: 'Form',
    href: '/dev/design-system/layout/form',
  ...
  {
    name: 'FloatingNav',
    href: '/dev/design-system/layout/floating-nav',
  ...
  {
    name: 'OverlayRoot',
    href: '/dev/design-system/layout/overlay-root',
...
export const designSystemNav = (currentPath: string, currentHash: string) => [
  { items: [{ label: 'Back to Dev Portal', href: '/dev', active: false, level: 1 as const }] },
  { items: [{ label: 'Overview', href: '/dev/design-system', active: currentPath === '/dev/design-system', level: 1 as const }] },
...
export const backendNav = (currentPath: string) => [
  { items: [{ label: 'Back to Dev Portal', href: '/dev', active: false, level: 1 as const }] },
  { items: [{ label: 'Dashboard', href: '/dev/backend', active: currentPath === '/dev/backend', level: 1 as const }] },
  {
    title: 'Detail Pages',
    items: [
      { label: 'Organisations', href: '/dev/backend/organisations', active: currentPath.includes('/dev/backend/organisations'), level: 2 as const },
      { label: 'RAM Cache', href: '/dev/backend/cache', active: currentPath.includes('/dev/backend/cache'), level: 2 as const }
    ]
  }
];
...
export const aiDevNav = (currentPath: string) => [
  { items: [{ label: 'Back to Dev Portal', href: '/dev', active: false, level: 1 as const }] },
  { items: [{ label: 'Context Hub', href: '/dev/aidev', active: currentPath === '/dev/aidev', level: 1 as const }] }
];